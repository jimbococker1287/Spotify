...
def append_technical_log_features(
    ...
    *,
    ...
    discover_technical_log_files_fn=None,
) -> pd.DataFrame:
    defaults = {
    ...
    if technical_files is None and discover_technical_log_files_fn is not None:
        technical_files = discover_technical_log_files_fn(data_dir, logger)
